  ...
  return (
    ...
    <Container className={classes.formContainer}>
      ...
      <Paper shadow="xl" withBorder radius="md" p="xl" style={{
        ...
        <Stack>           
        <Text className={classes.link} size="md" weight={600} onClick={()=>{ window.open(loadPublisher(address)?.link) }}>
        ...
        <Rating readOnly value={loadPublisher(address)?.trust} count={10}/>
        </Group>
        <Divider />
