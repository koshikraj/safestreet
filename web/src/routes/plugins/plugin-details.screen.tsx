import { Box, Center, Container, Group, Loader, Modal, Text, Image, Paper, Stack, Button, TextInput, Divider, Alert, Skeleton, Rating, useMantineTheme, Avatar, Chip, Select } from "@mantine/core";
import { useStyles } from "./plugin-details.screen.styles";
import usePluginStore from "../../store/plugin/plugin.store";
import { IconAlertCircle, IconAt, IconCheck, IconCopy, IconPlugConnected, IconCheckbox, IconWallet, IconSettings, IconPlaylistAdd, IconPlus, IconCross, IconMoneybag } from "@tabler/icons";
...
import { accountPaymentInfo, fullfillePayment, loadPublishDetails, publishWithPayment, loadPublisher } from "../../logic/safestreet";
import { formatEther, parseEther } from "ethers";



const tokenList: any = [{value: "0xb682DB693751b65430138aec47E09435D391f781" , label: 'SUSD', image: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/usd.svg', description: 'USD token'},
{value: "0x0000000000000000000000000000000000000000" , label: 'Ether', image: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/matic.svg', description: 'Matic on Polygon chain'},
{value: "0xb682DB693751b65430138aec47E09435D391f784" , label: 'USDT', image: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/usdt.svg', description: 'USDT on Polygon chain'},
{value: "0xb682DB693751b65430138aec47E09435D391f782" , label: 'DAI', image: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/dai.svg', description: 'DAI on Polygon chain'} 
]
...
export const PluginDetailsScreen = () => {
  ...
  return (
    ...
    >
      ...
      size="md"
      defaultValue={publishDetails.token ? publishDetails.token : paymentToken }
      itemComponent={SelectItem}
      data={tokenList}
      onChange={(value) => setPaymentToken(value)}
    />
      <TextInput
      defaultValue={publishDetails.amount ? formatEther(publishDetails.amount) : 0 }
    ...
    />
        ...
        >
          ...
          loading={saving}
          onClick={async () => {setSaving(true); await publishWithPayment(pluginDetails.address, paymentToken, paymentAmount); setSaving(false); setSettingsModal(false)}}
          sx={{
            display: "flex",
            flexDirection: "column",
      ...
      <Paper shadow="xl" withBorder radius="md" p="xl" style={{
        ...
        <Group>
          ...
          >
            ...
            <Text mt={"lg"} > Comirm the below payment details
            </Text>
          ...
          onClick={async () => {
             try {
             await fullfillePayment(pluginDetails.address, publishDetails.token, publishDetails.amount); 
            } 
           catch(e) {
             console.warn(e);
           }          
    ...
    {/* <Paper className={classes.formContainer} withBorder> */}
      ...
      <Paper shadow="xl" withBorder radius="md" p="xl" style={{
       ...
       <Group >
            ...
            <Button
              ...
              <Button
                onClick={async () => { setSettingsModal(true);  }}
      ...
      {!publishDetails.publisher ?
       ...
       <Paper >
            <Alert ref={ref} icon={<IconAlertCircle size="10rem" />}  title="Paid plugin" color="yellow" >
              This is a paid plugin. Make a payment to enable this on your Safe Account.
            </Alert> 
        ...
        { accountInfo.fullfilled && <Paper >
          <Alert icon={<IconCheck size="10rem" />}  title="Plugin subscribed" color="green" >
              You are subscribed. Enable the plugin now to use on your Safe Account.
          </Alert> 
          </Paper>
        }
        ...
        <Avatar size={60}  src= {loadPublisher(publishDetails.publisher)?.logo} alt="attester image" /> 
        <Stack>           
        <Text className={classes.link} size="md" weight={600}  >
         { loadPublisher(publishDetails.publisher)?.name} 
        </Text>

        <Text  className={classes.link} size="sm" opacity={0.65} >
