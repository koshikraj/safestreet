...
contract WhitelistPlugin is BasePluginWithEventMetadata {
    ...
    constructor()
        BasePluginWithEventMetadata(
            PluginMetadata({name: "Whitelist Plugin", version: "1.0.1", requiresRootAccess: false, iconUrl: "https://zenguard.xyz/static/media/recovery.7e44417e833b21dad68d105ebd8edb26.svg", appUrl: ""})
        )
    {}
